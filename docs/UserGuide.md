...
Use GIS program (e.g. QGIS) to connect to tile server backend and get ReSOW data directly
...
Click draw polygon buttion in bottom right

Left click around area of interest ensuring all features are within

Double click to complete polygon

Open download sub menu

Check the number of features to download is as expected
...
Select import new layer => vector tile

Fill out dialog box with:
